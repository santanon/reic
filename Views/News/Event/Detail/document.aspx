    ...
    <div id="main-wrapper">
        ...
        <div id="main-slider" class="main-slider">
            ...
            <div class="btn-back-onbanner">
                <div class="button">
                    <a class="btn-med btn-white" href="/News/Document"><i class="fas fa-angle-left" aria-hidden="true"></i>กลับไป</a>
                </div>
        ...
        <div class="" id="maincontainer-wrapper">
            ...
            <div class="content-editor no-bg">
                <div class="container padding-row">
                    ...
                    <div class="title color-secondary">เอกสารเผยแพร่ อื่นๆ</div>
