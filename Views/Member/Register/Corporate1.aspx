                    ...
                    <div class="register-wrapper">
                            ...
                            <div class="row">
                                    ...
                                    <a href="/Member/Register_General1">
                                        <div class="general box">
                                            ...
                                            <div class="name-type">
                                                ...
                                                <div class="text">สมาชิกทั่วไป</div>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <a href="/Member/Register_Corporate1">
                                        <div class="corporate box active">
                                            <div class="icon-type"></div>
                                            <div class="name-type">
                                                <div class="icon-check"></div>
                        ...
                        <div class="pst-center">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm- col-xs- col-  margin-bottom-half">
                                    <div class="slc-custom">
                                        <label for="country" class="sr-only">ประเภทธุรกิจ</label>
                        ...
                        <div class="row pst-right margin-top">
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm- col-xs- col- ">
                                <div class="button">
                                    <a href="/Member/Register_Corporate2" class="btn-med btn-icon-right btn-login btn-width" style="display: block; text-align: center;">ถัดไป <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
