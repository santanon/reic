        ...
        <div class="" id="maincontainer-wrapper">
                        ...
                        <div class="row">
                            <div class="col">
                                <ol class="breadcrumb">
                                    ...
                                    <li><a href="/Research/ResearchCategory" title="REIC Research Report Member">REIC Research Report Member</a></li>
                                    <li class="active"><span>สรุปสถานการณ์ที่อยู่อาศัยรายจังหวัด 26 จังหวัด</span></li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-editor">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="color-primary bold pst-center mb-3 mb-md-4">สรุปสถานการณ์ที่อยู่อาศัยรายจังหวัด 26 จังหวัด</h1>

                            <div class="mb-3">
                                <!--#include file="../Include/filter/inc-select.aspx"-->
                            </div>
