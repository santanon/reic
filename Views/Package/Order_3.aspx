                ...
                <div class="container padding-row">
                        ...
                        <ul>
                            ...
                            <li class="active">
                                <div class="name-step-wrapper">
                                    ...
                                    <div class="percent-step"><span class="num" style="display: none;">2</span><span class="success"><i class="fas fa-check"></i></span></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="line-step"><span></span></div>
                            </li>
                            <li class="active">
                                <div class="name-step-wrapper">
                                    <div class="name-step">ชำระเงิน</div>
                                    <div class="percent-step"><span class="num" style="display: none;">3</span><span class="success"><i class="fas fa-check"></i></span></div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="line-step">
                                    <span></span>
                        ...
                        <div class="col-md-6 col-md-print-6">
                            <div class="box-detail-order">
                                ...
                                <div class="order-result">
                                    <h2>คุณ ณรัฐ รุ่งเรื่อง</h2>
                                    <p>ที่อยู่ <span style="color: #00AFF0;">เลขที่ 63 ถนนพระราม9 เขตห้วยขวาง กรุงเทพฯ 10310</span></p>
                                    <p>เบอร์โทรศัพท์มือถือ <span style="color: #00AFF0;">098 222 2298</span></p>
                                    <p>อีเมล <span style="color: #00AFF0;">naratt_ratt@gmail.com</span></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-md-print-6">
                    ...
                    <div class="row pst-right my-3 print-display">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm- col-xs- col- ">
                            <div class="button">
                                <a href="#" class="btn-med btn-icon-right btn-login" style="display: block; text-align: center;">พิมพ์ <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
